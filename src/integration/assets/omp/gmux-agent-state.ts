...
const idleDebounceMs = parseDurationEnv("GMUX_OMP_IDLE_DEBOUNCE_MS", 250);
const retryGraceMs = parseDurationEnv("GMUX_OMP_RETRY_GRACE_MS", 2500);
...
export default function (pi) {
  ...
  pi.events.on("gmux:blocked", (data) => {
    if (!data?.active) {
